...
function UnstakeSection(props: {vault: TVaultData; onRefreshVaultData: () => void}): ReactElement {
	...
	const onUnstake = useCallback(async (): Promise<void> => {
		...
		if (isMax) {
			actualValue = props.vault.onChainData?.autoCoumpoundingVaultBalance || zeroNormalizedBN;
		}
			...
			{hasVaultTokens ? (
				<div
					className={cl(
						...
						'leading-4 border-2 border-neutral-900 bg-beige p-4'
					)}>
				...
				<div
					className={cl(
						...
						'border-2 border-neutral-900 bg-beige p-4'
					)}>
	...
	return (
		<div className={'grid lg:hidden'}>
			<div className={'rounded-lg border-2 border-neutral-900 bg-beige p-4'}>
				...
				<div className={'mt-2 flex items-center justify-between border-t border-neutral-400 pt-2'}>
